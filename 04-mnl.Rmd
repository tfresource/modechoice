...
kbl(thegoods, align = "c", booktabs = T, caption = "Numerical Example Illustrating Equivalent Difference Property: Probability of Each Alternative Before Adding Data") %>% 
kable_classic() %>% 
