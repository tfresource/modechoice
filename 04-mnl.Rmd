...
\begin{align*}
  Pr(i)&=&\frac{exp (V_i + {\Delta V })}{exp (V_{DA}+{\Delta V }) + exp (V_{SR}+{\Delta V }) + exp (V_{TR}+{\Delta V })} \\
  
  &=& \frac{exp (V_i) \times exp({\Delta V })}{exp (V_{DA}) \times exp({\Delta V }) + exp (V_{SR}) \times exp({\Delta V }) +            exp (V_{TR}) \times exp({\Delta V })} \\
