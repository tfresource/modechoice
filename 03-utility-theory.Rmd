...
$X_i,X_j$             are vectors of attributes describing alternatives i and j, respectively
                      (e.g., travel time, travel cost, and other relevant attributes of the available modes),  
 	                              
$S_t$                 is a vector of characteristics describing individual t, that influence  
                      his/her preferences among alternatives (e.g., household income and  
                      number of automobiles owned for travel mode choice),  
 	                              
$i$ f $j$             means the alternative to the left is preferred to the alternative to the  
                      right, and  
...
That is, two distinct parameters would be estimated for travel time; one for travel time by DA and SR,  , and the other for travel time by TR,  .  These parameters could be compared to determine if the differences are statistically significant or large enough to be important.
...
In this example,   represents the utility value of one minute of travel time to men and   represents the additional utility value of one minute of travel time to women.  Thus, the total utility value of one minute of travel time to women is  .  In this case,  , is expected to be negative indicating that increased travel time reduces the utility of an alternative.    may be negative or positive, indicating that women are more or less sensitive to increases in travel time.
