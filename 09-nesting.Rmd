...
```{r parallel two nest models, ehco = False}
m14SO <- mlogit(work_formula, data = sf_work)
m15SO <- mlogit(work_formula, data = sf_work,
               nests = list(motorized = c('Drive alone', 'Share ride 2', 'Share ride 3+','Transit'),  
                             non_motorized = c('Bike', 'Walk')),
               constPar = c("iv:non_motorized" = 1))
m16SO <- mlogit(work_formula, data = sf_work,
               nests = list(private_auto = c('Drive alone', 'Share ride 2', 'Share ride 3+'), 
                            other = c('Transit', 'Bike', 'Walk')),
               constPar = c("iv:other" = 1))
m17SO <- mlogit(work_formula, data = sf_work,
               nests = list(shared = c('Share ride 2', 'Share ride 3+'),  
                            other = c("Drive alone", "Transit",'Bike', 'Walk')),
               constPar = c("iv:other" = 1))
m18SO <- mlogit(work_formula, data = sf_work,
               nests = list(other = c("Drive alone", "Transit", 'Share ride 2', 'Share ride 3+'), 
                            non_motorized = c('Bike', 'Walk')),
               constPar = c("iv:other" = 1))
