...
```{r Decompositionoferrorvariance, fig.cap="Non-Motorized Nest in Parallel with Motorized, Private Automobile and Shared Ride Nests"}
knitr::include_graphics(rep("_bookdown_files/09-Preferred-nesting-structure_files/figure-html/Nonmotorizednestinparallel.PNG"))
```
...
```{r Decompositionoferrorvariance, fig.cap="Motorized-Shared Ride Nest (Model 26W)"}
knitr::include_graphics(rep("_bookdown_files/09-Preferred-nesting-structure_files/figure-html/Motorizedsharedridenest.PNG"))
```
...
```{r Hierarchical Two Nest Models for Shop/Other Trips}
