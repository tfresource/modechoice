...
Model 6W is the true model given that Model 7W has a higher 2
ρ . Since both models have the
...
Thus, the null hypothesis is that ββ β β 1 2 ===== " " s S , where βs , is the
vector of coefficients for the s
th market segment. Following the approach described in
...
Substituting the log-likelihood for the pooled model for RA and the sum of market segment
model log-likelihoods for UA in equation 5.16, the null hypothesis, that all segments have the
