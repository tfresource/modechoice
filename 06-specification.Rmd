...
```{r Table-6-2, echo = F}
tibble(
"Reference Model -->" = c("Loglikelihood Ratio", "Degrees of Freedom", "Significance"),
"Base Model vs Model 1W" = c(c(-2*(logLik(model_1w)-logLik(model_base)), df.residual(model_1w), p.value(model_1w)))
)%>%
