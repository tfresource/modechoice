...
#Having issues setting two variables to be equal to each other
...
model_11w <- mlogit(chosen ~ mot_tvtt + nm_tvtt + mot_ovttbydist + cost | hhinc + vehbywrk, data = sf_mlogit_autoavailability, constPar = c('hhinc:Share ride 2' = -0.002, 'hhinc:Share ride 3++' = -0.002))
...
model_11w <- mlogit(chosen ~ mot_tvtt + nm_tvtt + mot_ovttbydist + cost | hhinc + vehbywrk, data = sf_mlogit_tripcontext)
...
#Once we figure out the coefficient issue in the model I can convert this table to using direct functions
tibble(
