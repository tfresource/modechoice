...
model_3w <- mlogit(chosen ~ tvtt + cost | hhinc, data = sf_mlogit, constPar = c("incsh2", "incsh3" = 0))
...
model_1w <- mlogit(chosen ~ tvtt + cost | hhinc, data = sf_mlogit)
model_5w <- mlogit(chosen ~ tvtt + cost | hhinc, data = sf_mlogit)
model_6w <- mlogit(chosen ~ tvtt + cost | hhinc, data = sf_mlogit)
...
model_6w <- mlogit(chosen ~ nm_tvtt + mot_ovtt + mot_ivtt + cost | hhinc, data = sf_mlogit_trip_estimates)
model_7w <- mlogit(chosen ~ nm_tvtt  + ovtd + cost | hhinc, data = sf_mlogit_trip_estimates) #This one works
...
```{r Table 6-8 alternative Specifications of Travel Time, echo = F}

model_7w <- mlogit(chosen ~ tvtt + cost | hhinc , data = sf_mlogit)
model_10w <- mlogit(chosen ~ tvtt + cost | hhinc + vehbyhh, data = sf_mlogit)
model_11w <- mlogit(chosen ~ tvtt + cost | hhinc + vehbywrk, data = sf_mlogit)
model_12w <- mlogit(chosen ~ tvtt + cost | hhinc +  , data = sf_mlogit)
