...
tibble(
"Test" = c("Loglikelihood Ratio Test", "Degrees of Freedom", "Significance Level"),
"Base Model vs Model 1W" = c(-2*(logLik(model_1w)-logLik(model_base)), 1, chisq.test(model_1w, model_base)),
"Base Model vs Model 2W" = c(-2*(logLik(model_2w)-logLik(model_base)), 2, chisq.test(model_2w, model_base)),
"Base Model vs Model 3W" = c(-2*(logLik(model_3w)-logLik(model_base)), 2, chisq.test(model_3w, model_base)),
"Model 1W vs Model 2W" = c(-2*(logLik(model_2w)-logLik(model_1w)), 1, chisq.test(model_2w, model_1w)),
"Model 1W vs model 3W" = c(-2*(logLik(model_2w)-logLik(model_3w)), 1, chisq.test(model_2w, model_3w))
)%>%
